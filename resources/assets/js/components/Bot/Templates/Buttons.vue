    ...
    <div>
        <div v-if="elements.data.length > 0">
            ...
            <div v-for="element in elements.data" class="chip">
                ...
                <a href="" class="btn-floating red" @click.prevent="removeButton(element.id)">
        ...
        <form class="grey lighten-4" id="button-add" @submit.prevent="newButton()">
            ...
            <div class="input-field inline">
                ...
                <label class="action">Título</label>
            </div>
            <div class="input-field inline">
                <input type="text" placeholder="Qual é o destino?" v-model="dataToSave.postback" required>
                <label class="action">Destino</label>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            removeButton(id) {
                console.log("## - REMOVE BUTTON START = " + id);
